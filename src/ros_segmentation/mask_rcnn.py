...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        self.net = cv2.dnn.readNetFromTensorflow("/home/justin/realsense_ws/src/realsense-ros/realsense2_camera/src/semantic_segmentation/dnn/frozen_inference_graph_coco.pb",
                                            "/home/justin/realsense_ws/src/realsense-ros/realsense2_camera/src/semantic_segmentation/dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt")
        ...
        self.classes = []
        with open("//home/justin/realsense_ws/src/realsense-ros/realsense2_camera/src/semantic_segmentation/dnn/classes.txt", "r") as file_object:
